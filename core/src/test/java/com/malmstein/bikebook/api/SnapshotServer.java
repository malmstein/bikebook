...
public class SnapshotServer {
    ...
    public SnapshotServer(final String snapshotDir) {
    ...
    protected MockResponse tweakResponse(MockResponse response) {
        return response;
    }
    ...
    private String readFile(final String path) throws IOException {
        InputStream resourceAsStream = SnapshotBackendTest.class.getResourceAsStream(snapshotDir + path);
